...
def lnlike(theta, k_res, P, Perr):
    q1,q2 = theta
    model = th.makeP1D_P(k_res, q1=q1, q2=q2, kvav=kvav_f, kp=kp_f, av=av_f, bv=bv_f)*dkMz
...
#result_plot = th.makeP1D_P(k_res, q1=q1_ml, q2=q2_ml, kvav=kvav_f, av=av_f, bv=bv_f)*k_res/np.pi
#fake_plot = th.makeP1D_P(k_res, q1=q1_f, q2=q2_f,kvav=kvav_f,kp=kp_f, av=av_f,bv=bv_f)*k_res/np.pi
#ax.plot(k,fake_plot)
#ax.plot(k,result_plot)
#fig.savefig("../Figures/MCMC_NLParams_2/q1_q2/z"+z_str+"/IntitalFit_err"+err_str+".pdf")
##print(b_ml, betap_ml)
...
q1_list=np.linspace(min_1,max_1,100)
plt.plot(q1_list,[lnprob([q1, 0.6],k_res,P,Perr) for q1 in q1_list])
...
#    
#param1.show()
#param1.savefig("../Figures/MCMC_NLParams_2/q1_q2/z"+z_str+"/WalkerPathsq1_err"+err_str+".pdf")
#
#param2 = plt.figure(3)
#plt.ylabel('q2')
#for w in range(nwalkers):
...
#    
#param2.show()
#param2.savefig("../Figures/MCMC_NLParams_2/q1_q2/z"+z_str+"/WalkerPathsq2_err"+err_str+".pdf")
#
#
#
...
#    plt.plot(k, th.makeP1D_P(k_res, q1=q1, q2=q2, kvav=kvav_f, kp=kp_f, av=av_f, bv=bv_f)*k_res/np.pi, color="k", alpha=0.1)
...
#
#pathView.savefig("../Figures/MCMC_NLParams_2/q1_q2/z"+z_str+"/SamplePaths_err"+err_str+".pdf")
#pathView.show()
#
## Final results
#cornerplt = corner.corner(samples, labels=["$q1$", "$q2$"],
#                      truths=[q1_f, q2_f],quantiles=[0.16, 0.5, 0.84],show_titles=True)
#cornerplt.savefig("../Figures/MCMC_NLParams_2/q1_q2/z"+z_str+"/triangle_err"+err_str+".pdf")
#cornerplt.show()
#
#
#q1_mcmc, q2_mcmc = map(lambda v: (v[1], v[2]-v[1], v[1]-v[0]),
#                            zip(*np.percentile(samples, [16, 50, 84],
#                                                axis=0)))
#file = open("../Figures/MCMC_NLParams_2/q1_q2/z"+z_str+"_q1_q2.txt","a+") 
# 
#file.write('Prior width {0}, q1 {1}, q2 {2}.\n'.format(str(err), str(q1_mcmc),
#                                                       str(q2_mcmc))) 
#file.close() 
#
#print("q1:", q1_mcmc, "q2:", q2_mcmc)
#
#
#
#
